             ...
             for($i=0; $i<mysql_num_rows($res);$i++)
       {
		 ...
		 myPlacemark = new ymaps.Placemark([$x, $y], {
                hintContent: '$name3',
                balloonContent: '$name3 <br> Название:$name1 <br> Регион:$region, <br> Популяция:$population <br> Год:$year_created <br> Тип города:$city_type <br> Страна:$iso_country <br> Флаг:<img src=flags_iso/24/$iso_country.png>',
            ...
            iconImageHref: 'flags_iso/24/$iso_country.png',
            // Размеры метки.
            iconImageSize: [30, 42],
